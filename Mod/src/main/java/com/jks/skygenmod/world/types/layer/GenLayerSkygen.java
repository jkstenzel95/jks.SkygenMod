package com.jks.skygenmod.world.types.layer;
...
public class GenLayerSkygen extends GenLayer
{
    @SuppressWarnings("unchecked")
    private java.util.List<net.minecraftforge.common.BiomeManager.BiomeEntry>[] biomes = new java.util.ArrayList[net.minecraftforge.common.BiomeManager.BiomeType.values().length];
    private final ChunkGeneratorSettings settings;

    public GenLayerSkygen(long p_i45560_1_, GenLayer p_i45560_3_, WorldType p_i45560_4_, ChunkGeneratorSettings p_i45560_5_)
    {
        super(p_i45560_1_);
        ...
        biomes[idx].add(new BiomeEntry(Biomes.DESERT, 30));
        ...
        biomes[idx].add(new BiomeEntry(Biomes.DESERT, 30));
		/*
		 * biomes[desertIdx].add(new
		 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.SAVANNA, 20));
		 * biomes[desertIdx].add(new
		 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.PLAINS, 10));
		 */

        if (p_i45560_4_ == WorldType.DEFAULT_1_1)
        {
        	idx = BiomeType.DESERT.ordinal();
            biomes[idx].add(new BiomeEntry(Biomes.DESERT, 30));
            idx = BiomeType.WARM.ordinal();
            biomes[idx].clear();
            biomes[idx].add(new BiomeEntry(Biomes.DESERT, 30));
			...
			/*
			 * biomes[desertIdx].add(new
			 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.FOREST, 10));
			 * biomes[desertIdx].add(new
			 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.EXTREME_HILLS, 10));
			 * biomes[desertIdx].add(new
			 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.SWAMPLAND, 10));
			 * biomes[desertIdx].add(new
			 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.PLAINS, 10));
			 * biomes[desertIdx].add(new
			 * net.minecraftforge.common.BiomeManager.BiomeEntry(Biomes.TAIGA, 10));
			 */
            this.settings = null;
        }
        else
